      ...
      <section style={{ background: S.surface, padding: '32px 40px', borderTop: `1px solid ${S.borderFaint}`, borderBottom: `1px solid ${S.borderFaint}` }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'center', marginBottom: 20 }}>
            <img src="/logo.svg" alt="" style={{ width: isDark ? 27 : 34, height: isDark ? 27 : 34, objectFit: 'contain', background: isDark ? 'transparent' : '#000', borderRadius: isDark ? 0 : 4 }} />
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 48 }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                <img src="/logo.svg" alt="" style={{ height: isDark ? 44 : 58, width: 'auto', objectFit: 'contain', background: isDark ? 'transparent' : '#000', borderRadius: isDark ? 0 : 6, padding: isDark ? 0 : 3 }} />
          ...
          <div style={{ borderTop: `1px solid ${S.borderFaint}`, paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <a
                href="https://www.linkedin.com/company/accra-creatives-hub/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: S.textFaint, display: 'flex', alignItems: 'center', gap: 4, textDecoration: 'none', transition: 'color 0.2s' }}
              ...
              >
                ...
                <span style={{ fontSize: 10, fontFamily: S.body, letterSpacing: '0.1em', textTransform: 'uppercase' }}>LinkedIn</span>
              </a>
            </div>
          </div>
        </div>
