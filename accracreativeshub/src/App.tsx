...
const legalInlineLinkStyle: React.CSSProperties = {
  color: S.gold,
...
export default function App() {
  ...
  // Standalone legal pages for Google crawler / direct URLs
  if (path === '/privacy') {
    return <PrivacyPage />
  }

  if (path === '/terms') {
    return <TermsPage onClose={() => (window.location.href = '/')} />
  }
    ...
    >
      ...
      {showAbout && (
        <AboutPage
          ...
          onContact={() => {
            setShowAbout(false)
            openOverlay(() => setShowContact(true))
          }}
        />
      )}
      ...
      <section id="marketplace" style={{ padding: '96px 40px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="search-row" style={{ display: 'flex', gap: 12, marginBottom: 28, flexWrap: 'wrap' }}>
            <div
              className="market-search-input-row"
              style={{ display: 'flex', flex: 1, minWidth: 260, gap: 0 }}
            >
              <input
                value={search}
      ...
      <section
        id="for-designers"
        className="for-designers-section"
        style={{ padding: '96px 40px', background: S.bgDeep }}
      >
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div
            className="for-designers-grid"
          ...
          >
            <div>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                <Btn variant="gold" size="lg" onClick={() => openOverlay(() => setShowSignup(true))}>
                  Apply to Join →
                </Btn>
                {isAdmin && (
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            <div>
              ...
              {[
                ...
                ...(isAdmin
                  ? [{ label: 'Admin Panel', fn: () => openOverlay(() => setShowAdmin(true)) }]
                  : []),
              ].map((l) => (
                <div
                  key={l.label}
            ...
            <div>
              ...
              <a href="/#for-designers" style={footerLinkStyle}>For Designers</a>
          ...
          >
            <Body style={{ fontSize: 11, margin: 0 }}>
              ...
              <a href="/terms" style={legalInlineLinkStyle}>Terms</a> ·{' '}
              <a href="/privacy" style={legalInlineLinkStyle}>Privacy Policy</a>
            </Body>
