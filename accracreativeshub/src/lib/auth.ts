...
export const signUpUser = async ({
  ...
  // Detect existing unconfirmed account
...
export const handleGoogleUser = async (user: any) => {
  ...
  // Return the role (from DB or metadata)
...
<tr><td style="padding:36px 40px 28px;text-align:center;border-bottom:1px solid rgba(201,168,76,0.12);">
...
<tr><td style="background:#0d0d0d;padding:20px 40px;text-align:center;border-top:1px solid rgba(201,168,76,0.1);">
  <p style="color:#444;font-size:11px;margin:0;">© ${new Date().getFullYear()} Accra Creatives Hub · Accra, Ghana &nbsp;·&nbsp; <a href="https://accracreativeshub.com" style="color:#c9a84c;text-decoration:none;">accracreativeshub.com</a></p>
</td></tr>
</table>
</td></tr></table>
</body></html>`
...
const clientMail = (name: string) => wrap(`
  ...
  <div style="background:#0d0d0d;border-left:3px solid #c9a84c;padding:14px 18px;margin:20px 0;border-radius:0 4px 4px 0;">
    <p style="color:#aaa;font-size:12px;margin:0;line-height:1.7;">📬 Can't find it? Check your <strong style="color:#f5f5f5;">spam / junk</strong> folder.</p>
  </div>
  <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
    <tr><td align="center"><a href="https://accracreativeshub.com" style="display:inline-block;background:#c9a84c;color:#131313;font-family:Arial;font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;text-decoration:none;padding:15px 36px;">BROWSE DESIGNERS →</a></td></tr>
  </table>
`)
...
const designerMail = (name: string) => wrap(`
  ...
  <p style="color:#555;font-size:12px;margin:0;">Questions? <a href="mailto:designers@accracreativeshub.com" style="color:#c9a84c;">designers@accracreativeshub.com</a></p>
`)