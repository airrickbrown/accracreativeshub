      ...
      <div className="ach-modal ach-sheet" style={{ zIndex: 300, background: '#111114', border: '1px solid rgba(201,168,76,0.14)', boxShadow: '0 32px 80px rgba(0,0,0,0.7)', overflowY: 'auto', padding: '0 0 40px' }}>
        ...
        <div style={{ padding: '4px 28px 0' }}>
          ...
          <button
            ...
            onMouseEnter={(e: any) => { if (!loading) e.currentTarget.style.background = 'rgba(255,255,255,0.11)' }}
            onMouseLeave={(e: any) => { e.currentTarget.style.background = loading ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.07)' }}
          >
