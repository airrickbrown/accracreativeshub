...
export default function AuthModal({
  ...
  const handleGoogleAuth = async () => {
    setLoading(true)
    setError('')
    // Store role hint for GoogleRoleModal if designer-locked
    try {
      if (lockRole === 'designer') localStorage.setItem('ach_oauth_role_hint', 'designer')
      else localStorage.removeItem('ach_oauth_role_hint')
    } catch { /* ignore */ }
        ...
        <div style={{ padding: '4px 28px 0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <span style={{ fontFamily: S.body, fontSize: 11, color: S.textFaint, letterSpacing: '0.08em' }}>or</span>
              <div style={{ flex: 1, height: 1, background: S.borderFaint }} />
            </div>
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => { if (!loading && (e.key === 'Enter' || e.key === ' ')) handleGoogleAuth() }}
              style={{
            ...
            >
              ...
              <span style={{ fontFamily: S.body, fontSize: 14, color: S.text, fontWeight: 500 }}>
